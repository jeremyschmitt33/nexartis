...
/**
 * LocalIntro — Longue intro éditoriale localisée + mots-clés en chips.
 *
 * Apporte le premier paragraphe long que les LLM citeront en priorité,
 * et qui ancre la page sur la ville (intent local search).
 */
  ...
  return (
    <section id="introduction" className="scroll-mt-24">
      ...
      <h2 className="font-hanken text-2xl font-extrabold leading-tight tracking-tight text-[#0f1a3a] md:text-3xl">
        Nexartis pour les artisans de {ville} : pourquoi c&apos;est différent
      </h2>
