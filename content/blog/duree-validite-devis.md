---
title: "Combien de temps un devis est-il valable ?"
description: "La durée de validité d'un devis n'est pas imposée par la loi mais reste obligatoire. Repère usuel de 1 à 3 mois dans le bâtiment : nos explications."
...
tags: ["durée de validité devis", "devis bâtiment", "devis artisan", "mentions obligatoires devis", "engagement devis", "devis expiré"]
canonical: "https://nexartis.fr/blog/duree-validite-devis"
ogImage: ""
---
...
Si aucune clause n'a été prévue et que le client signe pendant la validité, vous devez honorer le prix. La meilleure prévention reste donc un devis bien construit dès le départ, comme expliqué dans notre méthode pour [faire un devis bâtiment](/blog/comment-faire-devis-batiment) complet et sécurisé.
...
Une fois le devis signé, il devient un contrat et l'artisan doit exécuter les travaux dans le délai indiqué. À défaut de date précisée, l'article L216-1 du Code de la consommation impose de réaliser la prestation dans un délai de 30 jours suivant la signature. Pour un particulier, mieux vaut donc inscrire une date de début et une durée estimée, comme le rappelle notre méthode pour [faire un devis bâtiment](/blog/comment-faire-devis-batiment).

## Sources officielles

- [Arrêté du 24 janvier 2017 — Légifrance](https://www.legifrance.gouv.fr/loda/id/JORFTEXT000033935513)
- [Devis : informations et obligations — economie.gouv.fr](https://www.economie.gouv.fr/dgccrf/les-fiches-pratiques/devis)
- [Devis obligatoire : activités concernées — service-public.fr](https://www.service-public.fr/particuliers/vosdroits/F31144)
- [Délais de livraison et d'exécution — article L216-1, Code de la consommation, Légifrance](https://www.legifrance.gouv.fr/codes/section_lc/LEGITEXT000006069565/LEGISCTA000032224346)
