---
title: "Comment faire un devis bâtiment : le guide pas à pas"
description: "Comment faire un devis bâtiment conforme et convaincant : mentions obligatoires, structure, calcul du prix et erreurs à éviter, étape par étape."
...
tags: ["devis bâtiment", "devis travaux", "mentions obligatoires", "artisan BTP", "auto-entrepreneur", "facturation", "TVA travaux"]
canonical: "https://nexartis.fr/blog/comment-faire-devis-batiment"
ogImage: ""
---
...
Au-dessous de ce seuil, le devis reste fortement conseillé, mais il n'est pas imposé pour ces activités. Le détail des activités concernées est précisé sur [service-public.fr](https://entreprendre.service-public.gouv.fr/vosdroits/F31144).

Ne pas remettre de devis quand il est obligatoire constitue une contravention de 5e classe, sanctionnée par une **amende pouvant atteindre 1 500 €**, montant porté à **3 000 € en cas de récidive**, comme le rappelle [economie.gouv.fr](https://www.economie.gouv.fr/entreprises/devis-obligatoire). Cette sanction se distingue de l'amende qui frappe un manquement à l'obligation d'information précontractuelle du consommateur, laquelle peut atteindre 3 000 € pour une personne physique et 15 000 € pour une société. Établir un devis systématique, même pour les petits montants, reste donc la pratique la plus sûre.
...
Si vous demandez un acompte à la signature, indiquez son montant et ses conditions directement sur le devis. Nous détaillons les bonnes pratiques dans notre guide sur l'[acompte devis bâtiment](/blog/acompte-devis-batiment).
...
Lorsque vous signez un devis chez un particulier à la suite d'un démarchage à domicile, c'est-à-dire hors de votre établissement, le client bénéficie d'un **droit de rétractation de 14 jours**, prévu par l'article L221-18 du [code de la consommation](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000032226842/). Vous devez l'en informer et joindre un formulaire type. À défaut, ce délai peut être prolongé jusqu'à douze mois. Cette obligation ne s'applique pas lorsque le client vient signer dans vos locaux.
...
La deuxième erreur concerne la TVA : se tromper de taux ou oublier de préciser le statut de franchise crée un écart sur le total et complique la facturation. Une fois le devis accepté, ce devis sert de base directe à votre [logiciel de devis et factures](/logiciel-devis-factures), il vaut donc mieux qu'il soit juste dès le départ.
...
[Nexartis](/) est un logiciel français de devis, factures, planning et suivi de chantier conçu pour les artisans du bâtiment. Il propose la **signature électronique** des devis à distance, des relances automatiques pour les devis sans réponse et l'application automatique des mentions légales. Les auto-entrepreneurs y trouveront un outil adapté à leur réalité, comme le détaille notre page [logiciel artisan auto-entrepreneur](/logiciel-artisan-auto-entrepreneur).
...
Une fois le devis signé et les travaux réalisés, vous établissez une facture qui reprend les éléments du devis. Pour les auto-entrepreneurs, les règles spécifiques sont détaillées dans notre guide sur la [facture auto-entrepreneur bâtiment](/blog/facture-auto-entrepreneur-batiment).
