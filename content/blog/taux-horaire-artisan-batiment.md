---
title: "Taux horaire d'un artisan du bâtiment : comment le calculer"
description: "Méthode complète pour calculer le taux horaire artisan : coût de revient, heures facturables, marge et exemple chiffré, avec fourchettes par métier."
...
tags: ["taux horaire artisan", "coût de revient", "rentabilité BTP", "gestion artisan", "devis bâtiment", "marge artisan", "tarif main d'œuvre"]
canonical: "https://nexartis.fr/blog/taux-horaire-artisan-batiment"
ogImage: ""
---
...
Ces fourchettes sont issues de relevés de prix publiés par les plateformes spécialisées du BTP, comme le [comparateur Ootravaux](https://www.ootravaux.fr/construction-renovation/maconnerie-fondations/maconnerie/tarif-horaire-macon.html), et recoupées avec les outils de calcul de prix de la [FFB](https://www.ffbatiment.fr/gestion-entreprise/devis-publicite-relations-clients/definir-mon-prix) et de la [CAPEB](https://www.capeb.fr/service/calculer-ses-prix). Si votre taux calculé sort de la fourchette de votre métier, ce n'est pas forcément une erreur : cela peut refléter une spécialité, une zone géographique ou un niveau de finition particulier. C'est à vous d'analyser l'écart.
...
Pour maîtriser cette chaîne, vous pouvez consulter notre guide pour [comment faire un devis dans le bâtiment](/blog/comment-faire-devis-batiment) ainsi qu'un [exemple de devis de rénovation d'appartement](/blog/devis-renovation-appartement-exemple) qui détaille le report du **taux horaire artisan** ligne par ligne.
...
Sources : [FFB — Définir mon prix](https://www.ffbatiment.fr/gestion-entreprise/devis-publicite-relations-clients/definir-mon-prix), [CAPEB — Calculer ses prix](https://www.capeb.fr/service/calculer-ses-prix), [Ootravaux — Tarif horaire d'un maçon](https://www.ootravaux.fr/construction-renovation/maconnerie-fondations/maconnerie/tarif-horaire-macon.html).
