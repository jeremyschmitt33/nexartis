...
const data = {
  ...
  tvaNotes:
    "TVA 5,5% ravalement avec ITE (RGE QualiBat 7141), 10% peinture intérieure et entretien logement >2 ans, 20% neuf",
  ...
  tableauTva: [
    ...
    },
    {
      ...
      taux: "5,5%",
      conditions: "RGE QualiBat 7141 + logement >2 ans",
    },
    {
  ...
  faqCustom: [
    {
      ...
      answer:
        "Un logiciel devis peintre doit chiffrer au m² mur et plafond, gérer les trois taux de TVA peinture (5,5%, 10%, 20%), injecter la mention décennale obligatoire sur les ravalements avec étanchéité, et être compatible Factur-X dès l'échéance du 1er septembre 2026. Le marché propose plusieurs outils : [notre comparatif Tolteck](/blog/tolteck-avis) reste un choix simple et largement adopté, [notre avis Obat](/blog/obat-avis) ajoute la signature électronique, [Henrri reste gratuit](/blog/henrri-avis) mais n'est pas spécialisé BTP, et [Sage Batigest](/blog/batigest-avis) cible plutôt les structures de plus de 10 salariés. Nexartis se positionne à 15€ HT/mois pour Essentiel et 25€ HT/mois pour Complet, conçu pour les peintres solo et TPE. Voir [nos tarifs détaillés](/tarifs).",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Oui. La réforme française impose Factur-X en réception au 1er septembre 2026 pour toutes les entreprises, et en émission au 1er septembre 2027 pour les TPE et auto-entrepreneurs. Toutes les factures Nexartis sont générées au format Factur-X (un PDF lisible accompagné d'un fichier XML structuré embarqué), conformes au standard européen EN 16931. Vous n'avez aucune manipulation à faire : le format s'applique par défaut dès l'offre Essentiel à 15€ HT/mois. Vos factures peuvent ensuite être transmises à n'importe quelle plateforme de dématérialisation partenaire. Plus de détails sur [notre guide logiciel devis factures BTP](/logiciel-devis-factures).",
    },
    {
      question: "Comment chiffrer un ravalement de façade en copropriété ?",
      answer:
        "Dans Nexartis, vous créez un chantier dédié et vous y rattachez plusieurs documents : un devis initial pour le vote en assemblée générale, puis des factures de situation au fur et à mesure de l'avancement (montage échafaudage, lavage haute pression, première couche, finition). Vous appliquez 10% TVA si le ravalement est en entretien classique, 5,5% si vous intégrez une ITE avec votre certification RGE QualiBat 7141. La mention décennale Spinetta est injectée automatiquement sur la partie étanchéité de façade. La traçabilité est conservée chantier par chantier pour répondre aux demandes du syndic et du conseil syndical sur plusieurs années.",
    },
    {
