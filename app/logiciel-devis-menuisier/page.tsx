...
const data = {
  ...
  faqCustom: [
    ...
    },
    {
      ...
      answer:
        "Oui. Dans Nexartis, vous pouvez exiger un acompte à la signature du devis (le standard en menuiserie est de 30 à 40%, justifié par la commande chassis chez le fabricant). Pour les gros chantiers (remplacement de toutes les ouvertures, pergola, escalier sur mesure), vous facturez ensuite des situations intermédiaires : 40% à la signature, 30% à la livraison chassis sur chantier, 30% à la pose et au procès-verbal de réception. Le solde est calculé automatiquement à chaque étape, et chaque facture est rattachée au chantier d'origine pour conserver la traçabilité comptable. Les seuils auto-entrepreneur (37 500€ services, 85 000€ ventes) sont surveillés en continu pour éviter le franchissement non anticipé en cours d'année.",
    },
    {
      question:
