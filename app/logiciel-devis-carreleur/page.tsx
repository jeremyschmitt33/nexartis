...
const data = {
  ...
  faqCustom: [
    {
      ...
      answer:
        "Le bon logiciel devis carreleur doit gérer les trois taux de TVA (5,5% adaptation PMR, 10% rénovation, 20% neuf ou fourniture seule), séparer fournitures et pose sur des lignes distinctes, injecter automatiquement la mention décennale pour l'étanchéité, être compatible Factur-X dès l'échéance du 1er septembre 2026, et permettre un métré rapide depuis le chantier. Le marché propose plusieurs options : Tolteck (19-25€/mois) reste simple et largement adopté, Obat (25-79€/mois) ajoute la signature électronique, Henrri reste gratuit mais n'est pas spécifique BTP, et Sage Batigest cible plutôt les structures de 10 salariés et plus — voir [notre comparatif Batigest](/blog/batigest-avis). Nexartis se positionne à 15€ HT/mois pour Essentiel et 25€ HT/mois pour Complet, conçu spécifiquement pour les artisans solo et auto-entrepreneurs.",
    },
    {
  ...
  // ─── I — Maillage interne ─────────────────────────────────────────────
  ancresMaillage: [
    { href: "/logiciel-devis-plombier", label: "Logiciel pour plombier (salle de bain)" },
