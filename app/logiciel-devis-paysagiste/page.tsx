...
const data = {
  ...
  faqCustom: [
    {
      question: "Quel est le meilleur logiciel devis pour un paysagiste en 2026 ?",
      answer:
        "Le bon logiciel devis paysagiste doit gérer les contrats d'entretien récurrents avec facturation mensuelle ou trimestrielle, appliquer la TVA à 20% par défaut sur l'aménagement et l'entretien, être compatible Factur-X dès l'échéance du 1er septembre 2026, et permettre de créer un devis depuis le jardin du client en moins de 2 minutes. Le marché propose plusieurs options : [notre comparatif Tolteck](/blog/tolteck-avis) (19-25€/mois) reste simple, [notre avis Obat](/blog/obat-avis) (25-79€/mois) ajoute la signature électronique, [Henrri reste gratuit](/blog/henrri-avis) mais n'est pas spécifique BTP, et [Vertuoza](/blog/vertuoza-avis) cible plutôt les structures plus grandes. Nexartis se positionne à 15€ HT/mois pour Essentiel et 25€ HT/mois pour Complet, pensé pour les paysagistes solo et auto-entrepreneurs. Voir [nos tarifs détaillés](/tarifs).",
    },
    {
  ...
  // ─── I — Maillage interne ─────────────────────────────────────────────
  ancresMaillage: [
    { href: "/logiciel-devis-maconnerie", label: "Logiciel pour maçonnerie" },
